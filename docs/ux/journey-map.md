...
- **Alternate paths:** multiple variations → variation picker; multiple sellers → default to the authoritative/lowest-risk offer, list alternatives (Phase 4 dependency: `docs/product/product-resolution.md`, not yet produced).
